          ...
          <div className='container mx-auto w-11/12 px-2 py-4'>
                <form onSubmit={handleSubmit}>
                      <div className='relative'>
                            <input type="text" id="title" placeholder='Project Completion' className="block py-1 px-2 md:px-6 w-full h-[50px] md:h-[71px] border border-[rgba(184,182,182,1)] rounded text-xs md:text-sm text-black font-['Signika_Negative'] font-normal"/>
                      ...
                      <div className='relative'>
                            <textarea name="text" id="description" placeholder='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra sit in aliquam pretium. Diam consectetur at tincidunt sed non tempus faucibus posuere eu. Nisi, luctus turpis pharetra quis nunc nulla. At lectus faucibus mattis ante eleifend ac arcu. Nibh morbi adipiscing leo tempus non dolor viverra cras. Sapien in nulla cum fermentum auctor lectus orci. Felis tincidunt lacus, fermentum laoreet sit sit. Lacus, orci pretium, etiam justo lacus. Amet, ultrices eget auctor euismod vitae diam.' className="block mt-8 md:mt-10 py-4 px-2 md:px-6 w-full h-[120px] md:h-[180px] border border-[rgba(184,182,182,1)] rounded text-xs md:text-sm text-black font-['Signika_Negative'] font-normal"></textarea>
                      ...
                      <div className='relative'>
                            <input type="text" id="title" placeholder='Urgent  Important' className="block mt-8 md:mt-10 py-1 px-2 md:px-6 w-full h-[50px] md:h-[71px] border border-[rgba(184,182,182,1)] rounded text-xs md:text-sm text-black font-['Signika_Negative'] font-normal"/>
                            ...
                            <span className="text-[rgba(41,41,41,1)] absolute top-3 md:top-6 right-5 md:right-10"><ChevronDown/></span>
                      </div>

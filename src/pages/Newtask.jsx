...
const Newtask = () => {
    ...
    //each input usestates of the form to create newTask;
    ...
    const handleSubmit = async (e) => {
            ...
            //send post data parameters directly to my Node/Express server controller
            try { await axios.post("http://localhost:3000/api/v1/tasks", 
            ...
            <form onSubmit={handleSubmit}>
                  ...
                  <div className='relative mt-8 md:mt-10'>
                      <textarea 
                        ...
                        className="block py-4 px-2 md:px-6 w-full h-[120px] md:h-[180px] border border-[rgba(184,182,182,1)] rounded text-xs md:text-sm text-gray-700 font-['Signika_Negative'] font-normal focus:outline-none"
                      ></textarea>
                  ...
                  <div className='relative mt-8 md:mt-10'>
                      <select 
                        ...
                        className="block py-1 px-2 md:px-6 w-full h-[50px] md:h-[71px] border border-[rgba(184,182,182,1)] rounded text-xs md:text-sm text-gray-700 font-['Signika_Negative'] font-normal bg-white appearance-none focus:outline-none">
                  ...
                  <button 
                        type="submit"
                        disabled={submitting}
                        className="text-[rgba(250,249,251,1)] mt-6 md:mt-10 w-full h-[45px] md:h-[66px] font-['Signika_Negative'] font-medium border rounded bg-[rgba(151,79,208,1)] transition duration-200 cursor-pointer hover:opacity-90 disabled:opacity-50"> {submitting ? "Creating..." : "Done"}
                  </button>

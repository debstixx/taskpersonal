      ...
      <nav className='"bg-gray-900 shadow-md border-b-stone-500 w-full z-30'>
        <div className="container mx-auto w-11/12 px-2 py-2 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-10 items-center">
            <Link to="/newtask"><h1 className="font-['Signika_Negative'] text-2xl font-medium">
              New Task
            </h1></Link>
            <Link to="/mytask"><h1 className="font-['Signika_Negative'] text-2xl font-medium">
              All Tasks
            </h1></Link>
            <span>
        ...
        {isOpen && (
          <div className="md:hidden flex flex-col items-center bg-purple-400 px-4 space-y-1">
           <Link to="/newtask"><h1 className="text-lg text-white font-['Signika_Negative,_sans-serif']">New Task</h1></Link>
            <Link to="/mytask"><h1 className="text-lg text-white font-['Signika_Negative,_sans-serif']">All Tasks</h1></Link>
          </div>
        )}
      </nav>
      <div className="container mx-auto w-11/12 px-4 py-4 md:mt-4 flex flex-col gap-4 md:flex-row md:justify-between items-center">
        <div className="flex flex-col">
          ...
          <p className="text-base md:w-[495px] md:text-2xl md:font-normal font-['Signika_Negative'] text-[rgba(115,113,113,1)]">
            ...
            <Link to="/newtask"><button className="text-white text-sm mt-3 p-1 w-[50%] md:text-xl md:w-[40%] md:mt-3 bg-purple-500 md:px-3 md:py-2 rounded-lg border-2">
              Go to My Tasks
            </button></Link>
